...
<body>
    ...
    <br />
    <a href="datarekammedis.php">View Rekammedis</a>
    <br />
    <br />
    <h3>Edit Data</h3>
    <?php
...
tpeserta");
                            while ($d = mysqli_fetch_array($data)) {
                                if ($r['kode_peserta'] == $d['kode_peserta'])
                                    echo "<option value=" .
                                        $d['kode_peserta'] . " selected='selected'>" . $d['nama_peserta'] . "</option>";
                                else
                                    echo "<option value=" .
                                        $d['kode_peserta'] . ">" . $d['nama_peserta'] . "</option>";
                            }
                            ?>
                        </select>
                    </td>
...
tbidan");
                            while ($d = mysqli_fetch_array($data)) {
                                if ($r['kode_bidan'] == $d['kode_bidan'])
                                    echo "<option value=" .
                                        $d['kode_bidan'] . " selected='selected'>" . $d['nama_bidan'] . "</option>";
                                else
                                    echo "<option value=" .
                                        $d['kode_bidan'] . ">" . $d['nama_bidan'] . "</option>";
                            }
                            ?>
                        </select>
                    </td>
